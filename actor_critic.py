...
def actor_critic(env, estimator_policy, estimator_value, num_episodes, discount_factor=1.0):
    ...
    for i_episode in range(num_episodes):
        ...
        for t in itertools.count():
            ...
            # print("Value: {}; Target: {}; Error: {}".format(value_next, td_target, td_error))
            ...
            # print("Loss: {}".format(estimator_policy.update(state, td_error, action)))

            if i_episode > num_episodes - num_episodes:
...
with tf.Session() as sess:
    ...
    stats = actor_critic(env, policy_estimator, value_estimator, num_episodes=1000, discount_factor=0.9)
